...
// clang-format off
    ...
    xf::cv::Mat<XF_8UC1, NEWHEIGHT, NEWWIDTH, NPC1> resize_img;
	#pragma HLS stream variable=resize_img.data depth=2
    resize_img.rows = 800;
    resize_img.cols = 800;

    xf::cv::Mat<XF_8UC1, NEWHEIGHT, NEWWIDTH, NPC1> threshold_img;
	#pragma HLS stream variable=threshold_img.data depth=2
    resize_img.rows = 800;
    resize_img.cols = 800;
...
// clang-format off
    ...
    xf::cv::resize<XF_INTERPOLATION_NN, XF_8UC1, HEIGHT, WIDTH, NEWHEIGHT, NEWWIDTH, NPC1, MAXDOWNSCALE>(imgOutput0, resize_img);

    xf::cv::Threshold<XF_THRESHOLD_TYPE_BINARY_INV, XF_8UC1, NEWHEIGHT, NEWWIDTH, NPC1>(resize_img, threshold_img, 50, 100);
    ...
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, XF_8UC1, NEWHEIGHT, NEWWIDTH, NPC1>(threshold_img, img_gray);
}
#endif
#if GRAY2RGB
